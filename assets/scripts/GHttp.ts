        ...
        this.sendPost("break-record",
            {
                ...
                totalScore: data.totalScore, // 总得分
                firstTaskSuccessCount: data.firstTaskSuccessCount, // 任务1用户完成正确次数
                firstTaskReaction: data.firstTaskReaction, // 任务1用户正确反应时
                secondTaskSuccessCount: data.secondTaskSuccessCount, // 任务2用户完成正确次数
                secondTaskReaction: data.secondTaskReaction, // 任务2用户正确反应时
                thirdTaskSuccessCount: data.thirdTaskSuccessCount, // 任务3用户完成正确次数
                thirdTaskReaction: data.thirdTaskReaction, // 任务3用户正确反应时
                fourthTaskSuccessCount: data.fourthTaskSuccessCount, // 任务4用户完成正确次数
                fourthTaskReaction: data.fourthTaskReaction, // 任务4用户正确反应时
                LevelDifficultyEnd: data.LevelDifficultyEnd, // 结束时所处难度水平
                date: this.userdate
